...
def one_hot_encode_input(sequence):
    mapping = {'A': [1, 0, 0, 0, 0],
               ...
               '_': [0, 0, 0, 0, 0]}  # Placeholder for masking
...
def build_lstm_model(sequence_length=150, input_nucleotide_dim=5, output_nucleotide_dim=5, expression_dim=1):
    ...
    model = Model(inputs=[sequence_input, expression_input], outputs=lstm_dense_output)
...
if __name__ == '__main__':
    ...
    lstm_model = build_lstm_model(sequence_length=150, input_nucleotide_dim=5, output_nucleotide_dim=5, expression_dim=1)
